...
function mainLoop() {
    ...
    if (game.global.universe == 1){
        ...
        else if ((getPageSetting('AutoStance') == 3) || (getPageSetting('use3daily') == true && game.global.challengeActive == "Daily") && game.global.world >= getPageSetting('dWindStackingMin')) windStance();
        else if (game.global.uberNature == 'Wind' && getEmpowerment() == 'Wind' && getCurrentMapObject() == undefined && game.empowerments.Wind.currentDebuffPower < 300 && ) setFormation(5);
