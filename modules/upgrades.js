...
function buyUpgrades() {
	...
	var fuckbuildinggiga = (bwRewardUnlocked("AutoStructure") == true && bwRewardUnlocked("DecaBuild") == true && getPageSetting('hidebuildings')==true && getPageSetting('BuyBuildingsNew')==0);
